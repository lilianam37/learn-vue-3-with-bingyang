<template>
  ...
  blogPostContent="A muggle is a person without any magic"></BlogPost>
  <BlogPost id="1" 
  blog-post-title="What is a muggle?"
  blog-post-content="A muggle is a person without any magic"></BlogPost>
  <hr/>
   <BlogPost :id="blogPostId"
  :blog-post-title="blogPostTitle"
  :blog-post-content="blogPostContent"></BlogPost>
  <hr/>
  <Blog-Post v-for="post in posts" 
  :key="post.id"
  :id="post.id" 
  :blog-post-title="post.blogPostTitle"
  :blog-post-content="post.blogPostContent"></Blog-Post>
...
let blogPostTitle=ref("Harry Potter...")
let blogPostContent= ref("words words words")
